...
namespace Word_Download
{
    ...
    {
        //获取网页流
        static public Stream DownloadFile(string URL)
        {
            try
            {
                ...
                Myrq.Timeout = 1000 * 60 * 10 * 10;//30s
                Myrq.Proxy = null;
                Myrq.Method = "GET";
                Myrq.Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
                Myrq.Headers.Add("Accept-Language", "zh-cn,zh;q=0.8,en-us;q=0.5,en;q=0.3");
        ...
        static public string GetUA()      //随机获得UserAgent提高爬取成功率
        {
            string[] userAgents = {
