...
namespace LSR
{
    public partial class FunView1 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public FunView1(SqliteManager main_manager)
        {
            InitializeComponent();
        ...
        private void FunView1_Load(object sender, EventArgs e)
        {
            ...
            reader = manager.getPlannedReader();
        ...
        private void unpickNewWords()
        {
            ...
            label_sentence_CN_1.Text = "你还没有勾选今天的新单词哦~";
        ...
        private void getNextWord()
        {
            ...
            if (showords[current_index] == null)
            {
                ...
                if (reader.Read()) empty_flag = false;
                else
                {
        ...
        private void tile_known_ItemClick(object sender, TileItemEventArgs e)
        {
            ...
            if (!showords[current_index].operated)
            {
                ...
                manager.insertRecitedWords(current_word,
                                           showords[current_index].meaning_raw,
                                           showords[current_index].sentences_raw,
                                           showords[current_index].pronun_raw,
                                           1);
            }
            manager.setRecited(current_word);
            manager.setUnplaned(current_word);
            getNextWord();
        }
    ...
    {
        public string word;
        public string meaning_raw;
        public string sentences_raw;
        public string pronun_raw;
